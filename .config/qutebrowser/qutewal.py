...
if os.path.isfile(colors_absolute):
    ...
    # Type: QssColor
    c.colors.completion.match.fg = color3
    ...
    # Type: QtColor
    c.colors.downloads.stop.bg = color6
    ...
    # Type: QssColor
    c.colors.prompts.selected.bg = color5

    # Background color of the statusbar in caret mode.
    # Type: QssColor
    c.colors.statusbar.caret.bg = color6
    ...
    # Type: QssColor
    c.colors.statusbar.caret.selection.bg = color6
    ...
    # (https).
    # Type: QssColor
    c.colors.statusbar.url.success.https.fg = color8
